...
ARG NEMOCLAW_MODEL=meta/llama-3.1-8b-instruct
ARG NEMOCLAW_PROVIDER_KEY=nvidia
ARG NEMOCLAW_PRIMARY_MODEL_REF=nvidia/llama-3.1-8b-instruct
...
# Expose the gateway and browser control ports
EXPOSE 18789
EXPOSE 18791
